...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: `https://talkora.lovable.app${talkoraLogo.url}` },
      ...
      { name: "twitter:image", content: `https://talkora.lovable.app${talkoraLogo.url}` },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/png", sizes: "any", href: talkoraLogo.url },
      { rel: "shortcut icon", type: "image/png", href: talkoraLogo.url },
      { rel: "apple-touch-icon", sizes: "180x180", href: talkoraLogo.url },
      { rel: "mask-icon", href: talkoraLogo.url, color: "#1a1224" },
    ],
  }),
