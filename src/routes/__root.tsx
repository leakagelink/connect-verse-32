...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: `${APP_NAME} — Premium social communication` },
      { name: "description", content: "Chat with verified people from around the world. Safe, fun and secure social communication community." },
      { name: "theme-color", content: "#1a1224" },
      { property: "og:title", content: `${APP_NAME} — Premium social communication` },
      { property: "og:description", content: "Verified, safe, premium social chat community." },
